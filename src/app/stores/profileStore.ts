...
export default class ProfileStore {
    ...
    updateProfile = async (profile: Partial<Profile>) => {
        ...
        try {
            ...
            runInAction(() => {
                ...
                store.listingStore.updateProfileDisplayName(profile);
                this.loading = false;
            })
        } catch (error) {
            console.log(error);
    ...
    updateFollowing = async (username: string, following: boolean) => {
        ...
        try {
            ...
            store.listingStore.updateVisitorFollowing(username);
            runInAction(() => {
                if (this.profile
    ...
    loadUserListings = async (username: string, predicate?: string) => {
        ...
        try {
            const listings = await agent.Profiles.listListings(username, predicate!);
            runInAction(() => {
